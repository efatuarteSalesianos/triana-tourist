...
public class GlobalRestControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleConstrintViolationException(ConstraintViolationException ex, WebRequest request) {
        return buildApiErrorWithSubError(HttpStatus.BAD_REQUEST,
                "Errores de validación. Revise el contenido de los campos que se indican a continuación",
                request,
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return buildApiErrorWithSubError(HttpStatus.BAD_REQUEST, "Errores de validación. Revise el contenido de los campos que se indican a continuación",
                request,
                /*ex.getFieldErrors()
